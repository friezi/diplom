...
Zufallsintervall vergrößert (z.B. bis zu einem Maximalwert). Wird der Aktualitätsgrad zu gering, so muss dieser in Relation zur Größe
des Zufallsintervalls gesetzt werden, nun sollte ein Mittelwert der Aktualitätsrate angestrebt werden. 
