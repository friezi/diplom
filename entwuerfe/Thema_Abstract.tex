...
Nachrichten werden lediglich anhand des Feeds ausgewählt -- Filterdefinitionen,
z.B. über den Inhalt einer Nachricht, werden nicht unterstützt.  Dagegen muss
ein Subscriber den entsprechenden Publisher eigenmächtig kontaktieren, um den
...
Polling-Raten zur dauerhaften Überlastung der RSS-Server führen, weshalb
mittlerweile manche Server häufig pollende Nutzer blockieren.
\\\\
Ziel dieser Arbeit ist es, eine Überlastung des Servers zu verhindern und die Aktualität der Informationen beim Benutzer zu
erhöhen.  Damit dies erreicht werden kann, kooperieren die Nutzer, indem sie
die erhaltenen Informationen mittels eines Publish/Subscribe-Systems
miteinander austauschen.  Damit ist es den Nutzern außerdem möglich,
