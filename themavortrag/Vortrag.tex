...
\begin{frame}
  ...
  \begin{itemize}
    \item Das am meisten verbreitete Publish/Subscribe-System im Internet: RSS
    \item RSS: nicht Push sondern Polling
    \item RSS: von viele Anbietern unterstützt
...
\begin{frame}
  ...
  \vspace{0.5cm}
  Als Grundlage kann schon existierende Overlay-Netzwerk-Software dienen (z.B. REBECA\cite{MuFiBu:2001:ArchFrameECommApp}).
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item $\rightarrow$ Mindestens so viele, dass gewisse Aktualität d. F.'s erreicht wird
