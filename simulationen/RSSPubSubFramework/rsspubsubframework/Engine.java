    ...
    final synchronized public void run() {
        ...
        if (active) {
            if (numMessages == 0) {
                ...
                System.out.println("[" + d + "] simulation time  : " + simSteps
                        / 10 + "." + simSteps % 10 + "s");
                System.out.println("[" + d + "] # of messages    : "
                        + Message.getMessages());
                System.out.println("[" + d + "] max # of messages: "
                        + maxMessages);
                System.out.println("[" + d + "] avg # of messages: "
                        + (double) cumMessages / simSteps);
            } else {
                ++simSteps;
