...
Dadurch, dass der Wert $artt$ und nicht der Wert $cpp$ übermittelt wird, kann jeder Subscriber seinen eigenen $cpp$-Wert entsprechend seiner Voreinstellungen
...
mitteilen kann, muss nun jedesmal, wenn $RT$ abläuft, $rtt:=rto$ gesetzt und $artt$ neu berechnet werden.
