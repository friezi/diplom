...
Timer $RT$ näher betrachtet: auslösendes Ereignis ist die Aussendung eines Feed-Requests an den RSS-Server. Da es sich bei einer Anfrage allerdings um eine
...
beschriebenen Methode neu bestimmt werden: da ein Subscriber Inhalte prinzipiell bei mehreren RSS-Anbietern abonniert haben kann, müssen für jeden
