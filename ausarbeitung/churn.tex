...
\ref{cs:ausbalancierung_der_polling-perioden}), kann dieser den enthaltenen Wert des $feed.artt$ zwischenspeichern. Betritt ein neuer Subscriber das System, so
