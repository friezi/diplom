...
Lässt sich der Zeitpunkt $nextBuild$, zu dem der RSS-Server einen neuen Feed
...
den Tag legen. Es hängt von der Vorhersagbarkeit des Auftretens neuer Daten und der zeitlichen Möglichkeit ab, diese Daten bereit zu stellen. Stellen wir uns eine
...
aussieht, spielt Aktualität in diesem Fall keine große Rolle, so dass für die Interessenten ein relativ großer $\Delta I$ Wert festgelegt werden kann (z. B. 12
