...
(also nach Erhalt eines RSS-Feeds) beiträgt, dient der $rto$ zur Berechnung des $\varDelta ttr$ bei nicht erfolgreicher Anfrage, also nach Ablauf des
...
Wiederholungen relevante $rto$-Wert exponentiell gesteigert wird. Wir definieren also \todo{exponentiell}
\begin{equation}
sf(x):=x^2.
\end{equation}
