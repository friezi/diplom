...
\label{legende}
Hier findet sich eine Legende zur Erklärung der Diagramme.

\importgnuplotps{Legende der Diagramme}{Abb:Legende_Diagramme}{legende}

Auf der y-Achse wird die Anzahl der Anfragen an einen RSS-Server dargestellt. Unterhalb der Queue (``$<$Anfragen in der Queue$>$'') ist die Füllgröße
