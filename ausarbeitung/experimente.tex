...
Subscriber gleichzeitig Feed-Requests aussenden. Die $RT$s laufen also gleichzeitig ab. Die Zeitdifferenzen nehmen exponentiell zu, dies entspricht der
exponentiellen Zunahme der $rto$s. Nach jeder Spitze drosseln die nicht ausgesperrten Subscriber ebenfalls ihren $cpp$ und steigern diesen daraufhin allmählich.
