...
\subsection{Kurzzeitige Belastungsänderung}
...
Die Frage, wie das System auf kurzzeitige Veränderungen der Server-Reaktionsfähigkeit reagiert, soll hier untersucht werden. Ist ein Server für einen
...
auf eine 50-fach verminderte Reaktionsfähigkeit des Servers ($serviceTimeFactor=50$). Wie zu sehen ist, ändert sich der Verlauf der Kurve nur ganz geringfügig.
