...
die Enwicklung der Serverbelastung anhand der eingegangenen Feed-Requests. Von den Standardparametern
...
Standardabweichung, den Variationskoeffizienten, (Standardabweichung geteilt durch den Mittelwert) dargestellt. Der Einfluss der Größe eines Mittelwertes 
...
\importsmallgnuplotps{Serverbelastung: Ohne Churn-Kompensation}{Abb:ohne_Churn-Kompensation}{ToTR_NoChurnCompensation400_80_900_MVR}
\importsmallgnuplotps{Serverbelastung: Mit Churn-Kompensation}{Abb:mit_Churn-Kompensation}{ToTR_ChurnCompensation400_80_900_MVR}
...
Damit der Einfluss von Churn auf die Serverbelastung deutlich hervor tritt, wurde in diesem Experiment ein $serviceTimeFactor$ von 400 gewählt.
...
$InitialBrokerRSSFeed$ zu viel Zeit, so dass ein Subscriber schon den RSS-Server kontaktiert. Da die Werte für die Nachrichtenlaufzeiten
unserer Standard-Parameter sehr groß sind, haben wir für dieses Experiment folgende Nachrichtenlaufzeiten gewählt:
$rss\-Feed\-Msg\-RT:=7$ und $rss\-Feed\-Request\-Msg\-RT:=5$. Auch diese Werte sind im Vergleich zu in der Realität auftretenden Werten immer noch sehr hoch gewählt.
Allerdings wollen wir das System unter möglichst schlechten Bedingungen testen. Bei geringeren Übertragungsgeschwindigkeiten verbessert sich
die Auswirkung der Churn-Kompensation.\\
