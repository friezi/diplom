...
pegelt sich die Kurve jedoch auf Grenze die Server-Queue ein, so dass der RSS-Server an seiner Belastungsgrenze arbeitet.\\

\importsmallgnuplotps{Mittelwerte der Polling-Perioden}{Abb:Referenzverlauf_Mittelwerte_der_Polling-Perioden}{meanValueCPP_Referenzverlauf_MeanValueRanges}
...
\importsmallgnuplotps{Nachrichtenverzögerung}{Abb:Referenzverlauf_Nachrichtenverzoegerung}{avgMsgDelayRatio_Referenzverlauf_MeanValueRanges}

Abbildung \ref{Abb:Referenzverlauf_Nachrichtenverzoegerung} zeigt die den Graphen unserer in Abschnitt \ref{angestrebte_dienstguete} definierten Gütefunktion
$Vg$.\\
...
Hier wollen wir untersuchen, wie sich ein Ausbleiben der Ausbalancierung der Polling-Perioden auf die Adaption der Polling-Perioden auswirkt und ob es
...
beigetreten sind und ihre $RT$s daher annähernd zu gleichen Zeit ablaufen werden. Die Mittelwerte der Polling-Perioden aller Subscriber sollten sich
