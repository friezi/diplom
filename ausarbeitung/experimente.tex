...
haben wir in Abbildung \ref{Abb:Keine_Ausbalancierung_Variationskoeffizient_der_Mittelwerte_der_Polling-Perioden} noch den normierten Wert der
Standardabweichung (bezogen auf den Mittelwert), den Variationskoeffizienten, dargestellt.\\
...
Parameterwahl dargestellt. Bei Vergleich der Mittelwerte fällt auf, dass sich in beiden Fällen (nach völlig unterschiedlichem Verlauf)
die Mittelwerte bei ca. 100 000 Sekunden bewegen. Jedoch habe sich die Mittelwerte bei dem ausbalancierten Verfahren nach unten hin eingepegelt (Abbildung
...
(Abbildung \ref{Abb:Keine_Ausbalancierung_Standardabweichung_der_Mittelwerte_der_Polling-Perioden}) hat bei ende der Simulation die Standardabweichung
