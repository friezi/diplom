...
unterhält, in dem einige Ereignissen zwischengespeichert werden.\\
...
``KEEPALIVE''). Erhält ein Broker ein KEEPALIVE eines Subscribers, für den er den Zustand ``ist offline'' gespeichert hat, sollte er diesem eine
...
zu verloren gegangenen KEEPALIVEs, so gilt der Subscriber für seinen Broker als ``offline'', dieser wird ihm daraufhin keine Feeds mehr übermitteln.
