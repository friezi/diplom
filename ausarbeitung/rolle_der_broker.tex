...
``KEEPALIVE-Nachricht''). Erhält ein Broker eine KEEPALIVE-Nachricht eines Subscribers, für den er den Zustand ``ist offline'' gespeichert hat,
...
aufgrund von Netzüberlastung zu verloren gegangenen KEEPALIVE-Nachrichten, so gilt der Subscriber für seinen Broker als ``offline''. Dieser wird ihm
