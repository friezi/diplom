...
Zeit verschiedene Internet-Dienste entwickelt worden. Private Informationen können als e-mail (elektronische Post) versendet werden.
...
Die Enwicklung eines solchen Systems soll folgende Weiterenwicklung ermöglichen: RSS-Feeds können mit Hilfe von Filtern, welche durch Subscriber definiert werden,
...
Um diese Arbeit in angemessenem Rahmen zu halten, werden wir auf die Umsetzung von Filtertechniken nicht weiter eingehen, schaffen jedoch eine Basis für weitere Entwicklungen
in dieser Richtung. Als Ausgangspunkt für Erweiterungen verwenden wir die
...
Im Verlauf der Arbeit soll eine angemessene Lösung für die oben beschriebene Zielsetzung gefunden werden. Des Weiteren soll eine Simulationsungebung implementiert
...
In Kapitel \ref{Abschnitt:Grundlagen} geben wir zunächst einen Überblick über ausgewählte Grundbegriffe und Verfahren, soweit sie für diese Arbeit von Bedeutung sind,
und stellen diese vor. Im weiteren Verlauf der Arbeit werden wir Begriffe aus diesem Kapitel referenzieren.\\

Kapitel \ref{Abschnitt:RSS_mittels_verteiltem_pubsub} befasst sich mit RSS und der designbezogenen Problematik im Kontext einer großen Nutzergemeinde. Wir werden die
schon angesprochenen Ziele unserer Arbeit genauer formulieren und problematische Aspekte bei ihrer Umsetzung beleuchten. Zuletzt geben wir einen kurzen Überblick über
Arbeiten, die sich auf ähnliche oder andere Weise diesem Thema zugewandt haben.\\

In Kapitel \ref{adapt_informationsverteilung} werden wir ein auf unsere Zielsetzung abgestimmtes Lösungskonzept entwickeln. Die Entwicklung erfolgt dabei schrittweise,
und wir werden sie durch die Analyse der sich ergebenden Begleitumstände motivieren.\\
...
In Kapitel \ref{c:experimente} stellen wir Experimente vor, mit deren Hilfe wir die entwickelten Algorithmen getestet und evaluiert haben. Erläutert werden die Ergebnisse
durch geeignete Graphiken und Diagramme.\\
