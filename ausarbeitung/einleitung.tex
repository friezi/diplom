...
RSS-Feeds sind über die Channel zwar themenbasiert organisiert (siehe \cite{LiuVenSirer:2005:MeasureRSSPubSub}), jedoch wird die inhaltlich thematische
...
Möglichkeit, einen Nutzer, dessen Polling-Rate zu hoch ist, vorübergehend zu blocken (siehe \cite{Hicks:2004:RSSBandwith}).
...
Verteiltes Publish/Subscribe eignet sich hervorragend, um eine Lastverteilung, besonders auch (und damit) eine potenziell größere Aktualität
