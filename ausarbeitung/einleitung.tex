...
Bei dieser Art der Präsentation von Informationen spricht man von einem pull-basierten Ansatz, da ein Interessent den Informationsanbieter (bzw. seine Webseite)
aktiv kontaktieren muss, um einen aktuellen Stand der Informationen zu erhalten. 
...
ist Publish/Subscribe. Üblicherweise folgt es dem push-basierten Ansatz.
...
Publish/Subscribe (verteilt/push) eignen sich hervorragend, um eine Lastverteilung, besonders auch (und damit) eine potentiell größere Aktualität
