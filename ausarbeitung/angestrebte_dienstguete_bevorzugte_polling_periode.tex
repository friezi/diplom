...
Bei diesem Ziel gehen wir davon aus, dass jeder Klient spätestens nach einer von ihm festgelegten Zeitspanne $ppp$ (\glqq preferred polling-period\grqq{},
...
um die Dienstgüte (\glqq Quality of Service\grqq{}, QoS, siehe auch \cite{BeFiMu:2006:QoSPubSub}) bestimmen zu können. Mit ihrer Hilfe ist für einen Benutzer
...
Dabei ist $\varDelta pubDate$ die Zeitspanne vom aktuellen Zeitpunkt, zu dem ein Benutzer einen RSS-Feed erhält, bis zum am weitesten zurückliegenden neuen
...
Wie man unschwer erkennen kann, hängen beide Funktionen unmittelbar voneinander ab, da ihnen genau die gleichen Parameter zugrunde liegen. Der Deutlichkeit
halber haben wir dennoch die Dienstgüte bestehend aus diesen zwei Funktionen definiert.
...
Es stellt sich die Frage, welcher alternative Wert angemessen wäre, da \glqq kurze Periode\grqq{} und \glqq lange Periode\grqq{} relative
