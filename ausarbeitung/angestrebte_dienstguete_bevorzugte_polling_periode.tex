...
Bei diesem Ziel gehen wir davon aus, dass jeder Klient spätestens nach einer von ihm festgelegten Zeitspanne $ppp$ (``preferred polling-period'',bevorzugte Polling-Periode)
...
um die ``Quality of Service''(QoS,Dienstgüte) bestimmen zu können. Mit ihrer Hilfe ist für einen Benutzer nachvollziehbar, welche eventuellen Verbesserungen
ihm ein neues Verfahren gegenüber dem bisherigen bietet. Dafür definieren wir eine Bewertungsfunktion. Bei vielen Optimierungsproblemen ist es nötig,
eine zu minimierende Bewertungsfunktion zu wählen (Bsp. Suche nach kürzesten Wegen in einem Graphen). Obwohl uns in unserem Fall die Bewertungsfunktion
nicht dabei hilft, eine Optimierung durchzuführen, werden wir uns dennoch danach richten. Da der Aktualitätsgrad eine zu maximierende Funktion wäre, wählen
wir den Verzögerungsgrad ($Vg$) der RSS-Feeds:
\begin{equation}
Vg:=\frac{\varDelta pubDate\cdot 100}{ppp}
\end{equation}

Dabei ist $\varDelta pubDate$ die Zeitspanne vom aktuellen Zeitpunkt bis zum am weitesten zurückliegenden Ereignis innerhalb des letzten RSS-Feeds. Die
zeitliche Verzögerung eines RSS-Feeds wird also in Abhängigkeit von der bevorzugten Polling-Periode in Prozent angegeben.\\
